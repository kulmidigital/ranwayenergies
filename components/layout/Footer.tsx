          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 md:space-y-4">
              {services.map((service) => (
                <li key={service}>
                  <span className="text-sm md:text-base text-gray-300">{service}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 md:space-y-4">
              {contactInfo.map((info) => (
                <li key={info.label} className="flex items-start gap-2 md:gap-3">
                  <info.icon className="h-4 w-4 md:h-5 md:w-5 text-amber-500 flex-shrink-0 mt-1" />
                  <span className="text-sm md:text-base text-gray-300">{info.label}</span>
                </li>
              ))}
            </ul>
          </div>
