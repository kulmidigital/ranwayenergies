          ...
          <div className='container mx-auto px-4 md:px-6'>
            <motion.div
              ...
              <p className='text-base sm:text-lg md:text-xl text-gray-200'>
                Comprehensive energy solutions tailored to meet your needs with
        ...
        <div className='container mx-auto px-4 md:px-6'>
          <motion.div
            ...
            <p className='text-sm md:text-lg text-gray-600 mb-6 md:mb-8'>
              Visit our station today and discover the difference quality
              service makes.
            </p>
            <Link
...
const services = [
  {
    ...
    description:
      "Premium quality fuel products for all your vehicle needs, ensuring optimal performance and efficiency.",
    features: [
  ...
  },
  {
    ...
    description:
      "A one-stop shop for all your convenience needs while fueling up your vehicle.",
    features: [
  ...
  },
  {
    ...
    description:
      "Flexible and convenient payment options for all our services.",
    features: [
